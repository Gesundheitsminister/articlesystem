...
$plug_lang['settings_lv_fields'] = 'Anzuzeigende Felder in der Artikelübersicht <br/><small><strong>DATENFELD(ER) untereinander eingeben</strong><br/>Optional Angabe der Spaltenbreite (in Prozent) möglich: DATENFELD||BREITE<br/><br/>title teaser text custom1-35 editor</small>';
...
$plug_lang['spfnc_facebook_from'] = 'Absender <small><strong>optional</strong> (facebook-User/Page-ID)</small>';
$plug_lang['spfnc_facebook_to'] = 'Empfänger <small><strong>optional</strong> (facebook-User/Page-ID)</small>';
...
$plug_lang['spfnc_facebook_lastsent_postid_cf'] = 'Freidef. Feld zur Speicherung der facebook-Post-ID<small><br/>(vom Typ "Einz. Textfeld")</small> ';
$plug_lang['spfnc_facebook_media'] = 'Mediendatei - Freidef. Feld <small>(vom Typ "Bild","Datei" oder "Einz. Textfeld")</small>';
$plug_lang['spfnc_facebook_picture'] = 'Vorschaubild - Freidef. Feld <small>(vom Typ "Bild" oder "Einz. Textfeld")</small>';
...
$plug_lang['spfnc_facebook_url_man'] = 'Link-URL zu einer beliebigen Seite - Freidef. Feld: <small>(vom Typ "Link")<br/>Wird eine beliebige Seite gewählt, wird keine Link-URL zum Artikel generiert.<br/>Auch werden die Link-Titel- und ggf. Link-Beschreibungsangaben des Freidef. Feldes <br/>(vom Typ "Link") anstelle der artikel-link-bezogenen Angaben verwendet.</small>';
