...
$plug_lang['settings_lv_fields'] = 'Article fields to show in the overview <br/><small><strong>DATA FIELD(S) one below the order</strong><br/><br/>title teaser text custom1-35 editor</small>';
...
$plug_lang['spfnc_facebook_app_key'] = 'Application-ID/API-Key';
$plug_lang['spfnc_facebook_from'] = 'Sender <small><strong>optional</strong> (facebook-User/Page-ID)</small>';
$plug_lang['spfnc_facebook_to'] = 'Receiver <small><strong>optional</strong> (facebook-User/Page-ID)</small>';
...
$plug_lang['spfnc_facebook_lastsent_postid_cf'] = 'Free def. field to save the last post-ID';
$plug_lang['spfnc_facebook_media'] = 'Media file';
$plug_lang['spfnc_facebook_picture'] = 'Picutre';
